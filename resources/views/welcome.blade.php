...
<div class="container my-4">
    <div class="row">
        <!-- Carrusel de Basura Acumulada -->
        <div class="col-md-6">
            <!-- Título -->
            <h3 class="text-center mb-3">Acumulación de Basura</h3>
            <div id="carruselBasura" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://eju.tv/wp-content/uploads/2021/07/img_60f0600400430.jpg" class="d-block w-100" alt="Basura Acumulada">
                    </div>
                    <div class="carousel-item">
                        <img src="https://cdn.correodelsur.com/img/contents/images_980/2022/03/04/d81def00-80c0-4a8b-b10b-b11b2a686b4e.jpg" class="d-block w-100" alt="Basura Acumulada">
                    </div>
                </div>
                <button class="carousel-control-prev" type="button" data-bs-target="#carruselBasura" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon"></span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carruselBasura" data-bs-slide="next">
                    <span class="carousel-control-next-icon"></span>
                </button>
            </div>
        </div>

        <!-- Carrusel de Basureros/Contenedores -->
        <div class="col-md-6">
            <!-- Título -->
            <h3 class="text-center mb-3">Basureros y Contenedores</h3>
            <div id="carruselBasureros" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://scontent.flpb1-2.fna.fbcdn.net/v/t1.6435-9/124893871_2314121502066793_2978975340091145105_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=833d8c&_nc_ohc=vsaT_vl_2P8Q7kNvgEb30Vq&_nc_oc=Adia5GY3Z9gdR5csS0FMecN8GVWJwEqz6Q1XG_quoRiHkRZ7yze-KoN-kczbMtLMTP0&_nc_zt=23&_nc_ht=scontent.flpb1-2.fna&_nc_gid=A4eVSXquUtj1gpZ_cj4Hcus&oh=00_AYBQXCZXsXzLeT0uGrb7bDNouIG8cS83e9Uj-Tb_5egjNQ&oe=6789325A" class="d-block w-100" alt="Basurero Utilizado">
                    </div>
                    <div class="carousel-item">
                        <img src="https://lapatria.bo/wp-content/uploads/2021/11/2-3-1024x768.jpg" class="d-block w-100" alt="Basurero Utilizado">
                    </div>
                </div>
                <button class="carousel-control-prev" type="button" data-bs-target="#carruselBasureros" data-bs-slide="prev">
                    <span class="carousel-control-prev-icon"></span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carruselBasureros" data-bs-slide="next">
                    <span class="carousel-control-next-icon"></span>
                </button>
            </div>
        </div>
    ...
    <div class="d-flex h-100 bg-gray-900 text-gray-100">
        <!-- Sidebar con Controles -->
        <aside class="w-64 bg-gray-800 p-3 shadow-lg flex-shrink-0">
            <h3 class="text-xl font-bold text-center mb-3">Controles</h3>
            <div class="d-grid gap-2">
                <button id="toggleHeat" class="btn btn-primary btn-sm">Mostrar/Ocultar Puntos de Calor</button>
                <button id="toggleMarkers" class="btn btn-secondary btn-sm">Mostrar/Ocultar Marcadores</button>
                <button id="togglePolygons" class="btn btn-success btn-sm">Mostrar/Ocultar Áreas</button>
                <button id="toggleRoutes" class="btn btn-warning btn-sm">Mostrar/Ocultar Rutas</button>
                <button id="toggle-markers" class="btn btn-primary btn-sm">Mostrar/Ocultar Marcadores</button>
                <button id="toggle-shapes" class="btn btn-secondary btn-sm">Mostrar/Ocultar Formas</button>
                ...
                <button id="toggleRutas" class="btn btn-warning btn-sm">Mostrar/Ocultar Rutas</button>
                <button id="miUbicacion" class="btn btn-success btn-sm">Mi Ubicación</button>
                <button id="exportarJson" class="btn btn-info btn-sm">Exportar JSON</button>
            </div>
        </aside>
        ...
        <main class="flex-grow p-4 bg-gray-100 dark:bg-gray-900">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
                <div id="welcome-map" style="height: 600px; width: 100%; border-radius: 8px;"></div>
            </div>
        </main>
    </div>
    ...
    <footer class="bg-dark text-white text-center py-3">
        <p>&copy; 2024 Gestión de Residuos | Todos los derechos reservados</p>
    </footer>
